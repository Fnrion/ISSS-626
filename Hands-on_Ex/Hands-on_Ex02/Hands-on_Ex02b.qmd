---
title: "2(b)  2nd Order Spatial Point Patterns Analysis Methods"
author: "Zou Jiaxun"
date: "Sep 1, 2024"
...
### **2.4.2 Mapping the geospatial data sets**
...
Notice that at the interactive mode, **tmap** is using [**leaflet for R**](https://rstudio.github.io/leaflet/) API. The advantage of this interactive pin map is it allows us to navigate and zoom around the map freely. We can also query the information of each simple feature (i.e. the point) by clicking of them. Last but not least, we can also change the background of the internet map layer. Currently, three internet map layers are provided. They are: ESRI.WorldGrayCanvas, OpenStreetMap, and ESRI.WorldTopoMap. The default is ESRI.WorldGrayCanvas.
...
### **2.5.1 Converting from sf format into spatstat’s ppp format**
...
### **2.5.2 Handling duplicated points**
...
### **2.5.4 Combining point events object and owin object**
...
#### 2.5.4.2 Converting sf objects into ***owin*** objects
...
## **2.6 Second-order Spatial Point Patterns Analysis**

N/A

## **2.7 Analysing Spatial Point Process Using G-Function**
...
### **2.7.1 Choa Chu Kang planning area**

#### 2.7.1.1 Computing G-function estimation
...
#### 2.7.1.2 Performing Complete Spatial Randomness Test
...
### **2.7.2 Tampines planning area**

#### 2.7.2.1 Computing G-function estimation
...
#### 2.7.2.2 Performing Complete Spatial Randomness Test
...
## **2.8 Analysing Spatial Point Process Using F-Function**
...
### **2.8.1 Choa Chu Kang planning area**

#### 2.8.1.1 Computing F-function estimation
...
### **2.8.2 Performing Complete Spatial Randomness Test**
...
### **2.8.3 Tampines planning area**

#### 2.8.3.1 Computing F-function estimation
...
#### 2.8.3.2 Performing Complete Spatial Randomness Test
...
## **2.9 Analysing Spatial Point Process Using K-Function**
...
### **2.9.1 Choa Chu Kang planning area**
...
### **2.9.2 Tampines planning area**

#### 2.9.2.1 Computing K-fucntion estimation
...
#### 2.9.2.2 Performing Complete Spatial Randomness Test
...
## **2.10 Analysing Spatial Point Process Using L-Function**
...
### **2.10.1 Choa Chu Kang planning area**

#### 2.10.1.1 Computing L Fucntion estimation
...
#### 2.10.1.2 Performing Complete Spatial Randomness Test
...
### **2.10.2 Tampines planning area**

#### 2.10.2.1 Computing L-fucntion estimate
...
#### 2.10.2.2 Performing Complete Spatial Randomness Test
