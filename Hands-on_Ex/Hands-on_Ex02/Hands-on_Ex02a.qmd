---
title: " 2(a) 1st Order Spatial Point Patterns Analysis Methods"
author: "Zou Jiaxun"
date: "Aug 29, 2024"
...
![](images/clipboard-3540154445.png)
...
### **2.5.1 Converting sf data frames to sp’s Spatial\* class**
...
### **2.5.6 Combining point events object and owin object**
...
#### 2.6.1.1 Computing kernel density estimation using automatic bandwidth selection method
...
```{r}
kde_childcareSG_bw <- density(childcareSG_ppp.km, sigma = bw.diggle, edge = TRUE, kernel = "gaussian")
plot(kde_childcareSG_bw)
```

Notice that output image looks identical to the earlier version, the only changes in the data values (refer to the legend).

### **2.6.2 Working with different automatic badwidth methods**
...
### **2.7.2 Computing KDE by using adaptive bandwidth**
...
#### 2.7.3.2 Assigning projection systems
...
### **2.7.4 Visualising the output in tmap**
...
### **2.7.5 Comparing Spatial Point Patterns using KDE**
...
#### 2.7.5.3 Combining childcare points and the study area
...
#### 2.7.5.5 Computing fixed bandwidth KDE
