---
title: "10(b)  Calibrating Spatial Interaction Models with R"
author: "Zou Jiaxun"
date: "Oct 17, 2024"
...
## **10.5 Computing Distance Matrix**
...
![](images/clipboard-355779241.png)
...
### **10.5.1 Converting from sf data.table to SpatialPolygonsDataFrame**
...
### **10.5.2 Computing the distance matrix**
...
### **10.5.3 Labelling column and row heanders of a distance matrix**
...
### **10.5.4 Pivoting distance value by SUBZONE_C**
...
### **10.5.5 Updating intra-zonal distances**
...
## **10.6 Preparing flow data**

The code chunk below is used import *od_data* save in Chapter 10(a) into R environment.
...
### **10.6.1 Separating intra-flow from passenger volume df**
...
### **10.6.2 Combining passenger volume data with distance value**
...
## **10.7 Preparing Origin and Destination Attributes**

### **10.7.1 Importing population data**

```{r}
pop <- read_csv("data/aspatial/pop.csv")
```

### **10.7.2 Geospatial data wrangling**
...
### **10.7.3 Preparing origin attribute**
...
### **10.7.4 Preparing destination attribute**
...
### **10.8.3 Checking for variables with zero values**
...
### **10.8.4 Unconstrained Spatial Interaction Model**
...
![](images/clipboard-3649580228.png)
...
### **10.8.6 Origin (Production) constrained SIM**
...
![](images/clipboard-2031881913.png)
...
### **10.8.7 Destination constrained**
...
![](images/clipboard-590891243.png)
...
### **10.8.8 Doubly constrained**

In this section, we will fit a doubly constrained SIM by using the code chunk below.

The general formula of Doubly Constrained Spatial Interaction Model

![](images/clipboard-1489139447.png)
...
### **10.8.10 Visualising fitted values**
