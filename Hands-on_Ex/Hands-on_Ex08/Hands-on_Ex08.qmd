---
title: "8  Geographically Weighted Predictive Models"
author: "Zou Jiaxun"
date: "Oct 15, 2024"
...
## **8.7 Building a non-spatial multiple linear regression**
...
### **8.8.1 Converting the sf data.frame to SpatialPointDataFrame**
...
### **8.8.2 Computing adaptive bandwidth**
...
### **8.8.3 Constructing the adaptive bandwidth gwr model**
...
### **8.8.4 Retrieve gwr output object**
...
### **8.8.5 Converting the test data from sf data.frame to SpatialPointDataFrame**
...
### **8.8.6 Computing adaptive bandwidth for the test data**
...
### **8.8.7 Computing predicted values of the test data**
...
## **8.9 Preparing coordinates data**

### **8.9.1 Extracting coordinates data**
...
## **8.10 Calibrating Random Forest Model**
...
## **8.11 Calibrating Geographical Random Forest Model**
...
### **8.11.1 Calibrating using training data**
...
#### 8.11.2.2 Predicting with test data
...
#### 8.11.2.3 Converting the predicting output into a data frame
...
### **8.11.3 Calculating Root Mean Square Error**
...
### **8.11.4 Visualising the predicted values**
