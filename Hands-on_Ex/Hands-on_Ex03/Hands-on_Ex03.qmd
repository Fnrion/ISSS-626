---
title: "3 Network Constrained Spatial Point Patterns Analysis"
author: "Zou Jiaxun"
date: "Sep 2, 2024"
...
## plot(0:25, rep(1, 26), pch = 0:25, xlab = "pch", ylab = "", axes = FALSE) axis(1, at = 0:25, labels = 0:25) to see each pch
...
### **3.6.2 Generating line centre points**
...
```{r}
length(rep(1, nrow(childcare))) == nrow(childcare)
