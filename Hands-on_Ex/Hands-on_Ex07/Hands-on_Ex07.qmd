...
#### 7.8.2.1 Visualising the relationships of the independent variables
...
### **7.8.4 Preparing Publication Quality Table: olsrr method**
...
#### 7.8.5.1 Checking for multicolinearity
...
#### 7.8.5.2 Test for Non-Linearity
...
#### 7.8.5.3 Test for Normality Assumption
...
#### 7.8.5.4 Testing for Spatial Autocorrelation
...
#### 7.9.1.1 Computing fixed bandwith
...
The code chunk used look very similar to the one used to compute the fixed bandwidth except the `adaptive` argument has changed to **TRUE**.The result shows that the 30 is the recommended data points to be used.
...
#### 7.9.6.1 By URA Plannign Region
