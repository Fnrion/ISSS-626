---
title: "5(b)  Local Measures of Spatial Autocorrelation"
author: "Zou Jiaxun"
date: "Sep 25, 2024"
...
### **5.2.3 Setting the Analytical Toolls**
...
## **5.4 Local Indicators of Spatial Association(LISA)**
...
### **5.4.3 Computing local Moran’s I**
...
#### 5.4.3.1 Mapping the local Moran’s I
...
#### 5.4.3.2 Mapping local Moran’s I values
...
#### 5.4.3.3 Mapping local Moran’s I p-values
...
#### 5.4.3.4 Mapping both local Moran’s I values and p-values
...
## **5.5 Creating a LISA Cluster Map**

The LISA Cluster Map shows the significant locations color coded by type of spatial autocorrelation. The first step before we can generate the LISA cluster map is to plot the Moran scatterplot.

### **5.5.1 Plotting Moran scatterplot**
...
### **5.5.2 Plotting Moran scatterplot with standardised variable**
...
### **5.5.3 Preparing LISA map classes**
...
## **5.6 Hot Spot and Cold Spot Area Analysis**

Beside detecting cluster and outliers, localised spatial statistics can be also used to detect hot spot and/or cold spot areas.

The term ‘hot spot’ has been used generically across disciplines to describe a region or value that is higher relative to its surroundings (Lepers et al 2005, Aben et al 2012, Isobe et al 2015).

### **5.6.1 Getis and Ord’s G-Statistics**
...
### **5.6.2 Deriving distance-based weight matrix**
...
#### 5.6.2.2 Determine the cut-off distance
...
#### 5.6.2.3 Computing fixed distance weight matrix
...
### **5.6.3 Computing adaptive distance weight matrix**
...
## **5.7 Computing Gi statistics**

### **5.7.1 Gi statistics using fixed distance**
...
### **5.7.2 Mapping Gi values with fixed distance weights**
...
### **5.7.3 Gi statistics using adaptive distance**
...
### **5.7.4 Mapping Gi values with adaptive distance weights**
